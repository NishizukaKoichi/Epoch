...
export function SpellSpellForm() {
    ...
    <div className="mx-auto max-w-2xl px-4 py-8">
      ...
      <div className="mb-8">
        ...
        <div className="flex items-center gap-3">
          <div className="rounded-lg bg-spell-primary/10 p-2">
            ...
            <div className="flex flex-wrap gap-2 mb-4">
              {selectedScopes.map((scopeId) => (
                <Badge
                  key={scopeId}
                  variant="outline"
                  className="border-spell-primary text-spell-primary gap-1"
                >
                  {scopeId}
                  <button
                    type="button"
            ...
            >
              <div className="relative">
                ...
                <Label
                  ...
                  className="flex flex-col items-center justify-center rounded-lg border-2 border-border bg-card p-4 hover:bg-accent/50 peer-data-[state=checked]:border-spell-primary cursor-pointer"
                >
