      ...
      <main className="flex-1 flex items-center justify-center px-4 py-16">
        <div className="w-full max-w-sm">
          <div className="text-center mb-8">
            <div className="mx-auto mb-4 flex h-12 w-12 items-center justify-center rounded-full bg-spell-primary/10">
          ...
          {sent ? (
            <div className="rounded-lg border border-border bg-card p-6 text-center">
              <Mail className="mx-auto h-8 w-8 text-spell-primary mb-4" />
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <p className="text-center text-xs text-muted-foreground">
                ...
                <Link
                  href="/spell/landing"
                  className="text-spell-primary hover:underline"
                >
                  新規登録
                </Link>
              </p>
