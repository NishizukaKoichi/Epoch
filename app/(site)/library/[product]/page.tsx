...
const productData: Record<string, {
  ...
  epoch: {
    ...
    artifacts: {
      spec: "/epoch/landing",
      value: "/library/epoch/value",
      mvp: "/library/epoch/mvp",
      flows: "/library/epoch/flows",
      done: "/library/epoch/done",
    },
  ...
  spell: {
    nameKey: "product.spell.name",
    definitionKey: "product.spell.definition",
    status: "draft",
    nonGoals: [
      "処理の中身を検査しない",
      "価格や回数の判断をしない",
    ...
    integrationStance: "Talismanで主体を確定し、Spellで実行可否を判定する。Sigilの術式やPactの契約状態は、Spellの判定条件として外部で連携できる。",
  },
}
  ...
  if (!data) {
    return (
      <div className="mx-auto max-w-4xl px-4 py-16">
        ...
        <Link href="/library" className="text-sm text-foreground hover:underline mt-4 inline-block">
          Back to Library
        </Link>
      </div>
    )
